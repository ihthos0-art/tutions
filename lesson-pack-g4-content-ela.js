/* English — Grade 4 Interactive Lesson Pack.

   CONTENT PENDING. The teacher's material has not been supplied yet, so this
   array is deliberately empty: the page mounts, and the English tab renders
   ...
   Shape, once it lands (one entry per lesson, two per subject):
     ...
     {
       subject: 'English',
       lesson_id: 'en-l1',        // REQUIRED prefix — en- | ma- | sc- | ss-
