/* Science — Grade 4 Interactive Lesson Pack.

   CONTENT PENDING. The teacher's material has not been supplied yet, so this
   array is deliberately empty: the page mounts, and the Science tab renders
   ...
   Shape, once it lands (one entry per lesson, two per subject):
     ...
     {
       subject: 'Science',
       lesson_id: 'sc-l1',        // REQUIRED prefix — en- | ma- | sc- | ss-
